...
class _CameraPickerViewerState extends State<CameraPickerViewer> {
  ...
  /// Whether the controller hasalized.
  /// 控制器是否已初始化
  ...
  /// Actions section for the viewer. Including 'back' and 'confirm' button.
  /// 预览的操作区样式2。包括"返回"和"确定"按钮。
  Widget viewerActionsStyleBig(BuildContext context) {
    return SafeArea(
      child: Padding(
        padding: const EdgeInsets.fromLTRB(8.0, 0.0, 8.0, 50.0),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            const Spacer(),
