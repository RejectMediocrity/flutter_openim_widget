    ...
    return SizedBox(
      ...
      child: Row(
        children: <Widget>[
          ...
          if (/*cameras.length > 1*/ controller?.value.isRecordingVideo != true)
            Expanded(child: switchCamerasButton)
          else
            const Spacer(),
        ],
      ),
              ...
              children: <Widget>[
                Center(
                  child: AnimatedContainer(
                    ...
                    // padding: EdgeInsets.all(isShootingButtonAnimate ? 1 : 0),
